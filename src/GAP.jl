...
function __init__()
    ...
    GAP.Globals.HELP_ADD_BOOK(juliaInterface_pkgdoc.BookName, juliaInterface_pkgdoc.LongTitle, GAP.Globals.Directory(GapObj(abspath(dirname(JuliaInterface_path), "..", "..", "share", "doc", "JuliaInterface", "doc"))))
