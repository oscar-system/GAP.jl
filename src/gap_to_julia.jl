...
function gap_to_julia_internal(
    ...
    return gap_to_julia_internal(Vector{Any}, obj, recursion_dict, Val(recursive))
end
...
function gap_to_julia_internal(
    ...
    return gap_to_julia_internal(Matrix{Any}, obj, recursion_dict, Val(recursive))
end
...
function gap_to_julia_internal(
    ...
    return gap_to_julia_internal(Set{Any}, obj, recursion_dict, Val(recursive))
end
